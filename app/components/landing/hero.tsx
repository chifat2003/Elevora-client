...
export function Hero({ featuredJobs }: { featuredJobs: Job[] }) {
  ...
  return (
    <section className="flex min-h-[65vh] flex-col items-center justify-center bg-gradient-to-b from-primary/5 to-transparent px-4 py-16 text-center sm:px-6">
      ...
      {featuredJobs.length > 0 && (
        <div className="mt-6 flex h-6 items-center gap-2 text-sm text-neutral-500 dark:text-neutral-400">
          <span>Now hiring:</span>
          <span key={featuredJobs[titleIndex]._id} className="font-medium text-primary">
